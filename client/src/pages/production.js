  ...
  : fadeIn(".fadeIn");
	...
	<div className='product'>
		...
		<div className="container">
			...
			<p className="item-depart">GlobalxSolutions Production House</p>
            <p className="item-description">
			In the digital era, we have seen an unprecedented rise in the demand for DVC production. We love to hear about your thought, let’s have a cup of coffee and get a free consultation to give you a complete briefing about your brand’s video production strategy.
		    </p>
			<h2 className="item-title">GlobalxSolutions offers full production services to local and international clients.</h2>
            <p className="item-description">
        ...
        <div ref={sectionRef} className='inner'>
		  ...
		  We have majorly worked with real estate consultants, Hotels, Cafes, Builders and Developers automobile manufacturers and entertainment houses. Storytelling is not a piece of cake for everyone to describe it in the video format.
          </p>
          <div className='btn-row fadeIn'>
			  ...
			  WHAT WE OFFER AT OUR PRODUCTION HOUSE
			  </Link>
          </div>
        </div>
      	</div>
