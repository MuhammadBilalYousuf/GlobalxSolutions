  ...
  : fadeIn(".fadeIn");
	...
	<div className='product'>
		...
		<div className="container">
			...
			<p className="item-depart">GlobalxSolutions Digital House</p>
            <p className="item-description">
			GlobalxSolutions offers complete services of digital marketing to small and large companies. Having 8 years in marketing service to local and international clients, we understand the demands of the new brands and provide them required solutions with complete digital marketing strategy having media planning and content development cycle as per customer behavior and the product niche. 
		    </p>
        ...
        <div ref={sectionRef} className='inner'>
          <p className='fadeIn'>
			The world has become a global village and the rate of digitization is accelerating. We just do not provide an online presence to enterprises but we chalk out plans and execute them to stand out from the crowd. GlobalxSolutions takes your enterprise from dull to dazzling with the help of the experienced digital marketing strategists. 
          </p>
