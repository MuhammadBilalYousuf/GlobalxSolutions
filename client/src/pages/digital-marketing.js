...
import "../styles/pages/digital-marketing.scss";
...
const Product = () => {
	return (
		...
		<div className="container">
			...
			<p className="item-depart">DIGITAL MARKETING</p>
            <h2 className="item-title">PPC ADVERTISING / DISPLAY ADS</h2>
...
const Popup = () => (
  <Layout>
    <div className='grid-images-digital'>
