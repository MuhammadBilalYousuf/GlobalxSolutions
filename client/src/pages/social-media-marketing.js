...
import "../styles/pages/social-media-marketing.scss";
...
const Product = () => {
	return (
		...
		<div className="container">
			...
			<p className="item-depart">SOCIAL MEDIA MARKETING</p>
            <h2 className="item-title">SMS / EMAIL MARKETING</h2>
...
const Popup = () => (
  <Layout>
    <div className='grid-images-marketing'>
