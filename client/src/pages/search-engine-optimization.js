...
import "../styles/pages/search-engine-optimization.scss";
import Image from "../assets/work/work.jpg";
...
const Product = () => {
	return (
		...
		<div className="container">
            ...
            <h2 className="item-title">SEARCH ENGINE OPTIMIZATION</h2>
...
const images = [
  {
    bg: Image,
    title: 'Writing is Hard, So Publishing Should be Easy, here we beleive at Zeroland.',
...
const Popup = () => (
  <Layout>
    <div className='grid-images-publishing'>
